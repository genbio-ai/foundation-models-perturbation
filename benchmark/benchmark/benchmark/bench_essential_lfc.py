...
@hydra.main(version_base=None, config_path="config/essential", config_name="config_essential_lfc")
def main(cfg: DictConfig) -> None:
    ...
    if cfg.estimator_name == "no change":
        pipeline = DummyRegressor(strategy="constant", constant=np.zeros(6640))
        hparam_grid = {}
    ...
    backup_train_emb = np.random.random((train.X.shape[0], 100))
